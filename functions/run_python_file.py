...
schema_run_python_file = types.FunctionDeclaration(
    ...
    description = "Executes a Python script at the given file path and returns its terminal output (stdout/stderr).",
    parameters = types.Schema(
        ...
        required = ["file_path"], # args is omitted from required since it defaults to None
    ),
)